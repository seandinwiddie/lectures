...
| Advanced | Pure delta and metric transformations isolated from effects | [Metric projection core in `portfolio`](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/registry/observatory/signalArray/metrics/metricsAdapters.ts#L66-L121) |
| Advanced | RTK Query documents and Redux projections composed at the hook boundary | [Observatory query composition in `portfolio`](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/registry/observatory/signalArray/signalArrayThunks.ts#L23-L80) |
