...
| --- | --- | --- |
| Intermediate | One API slice registered once in the store | [Store wiring](https://github.com/seandinwiddie/portfolio/blob/main/src/store.ts#L12-L33) and [API root](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/substrate/kernel/api/apiApi.ts#L17-L70) in `portfolio` |
| Intermediate | Response normalization at the endpoint boundary | [Initial-state transformation in `portfolio`](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/substrate/kernel/api/apiApi.ts#L17-L70) |
