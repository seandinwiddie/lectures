...
| Advanced | Store root composes domain reducers, RTK Query, and listener middleware | [Store composition in `portfolio`](https://github.com/seandinwiddie/portfolio/blob/main/src/store.ts#L12-L33) |
