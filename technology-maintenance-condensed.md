...
Use these production examples to move from a local rule to a mechanically enforced application boundary.
...
| Advanced | Store wiring composes RTK middleware with ECS-owned entity reducers | [Store composition](https://github.com/seandinwiddie/portfolio/blob/main/src/store.ts#L12-L33) and [entity reducer registry](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/substrate/kernel/composition/compositionReducers.ts#L1-L11) in `portfolio` |
