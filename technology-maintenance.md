...
Use the ladder to turn each maintenance rule into an inspectable contract. The linked examples provide concrete review targets as the production architecture evolves.

| Level | Concept | Production source |
| --- | --- | --- |
| Beginner | Behavior protected by a focused reducer test | [Theme-selection slice tests in `portfolio`](https://github.com/seandinwiddie/portfolio/blob/main/src/features/entities/bridge/spectrum/themeSelection/themeSelectionSlice.test.ts#L11-L72) |
| Intermediate | Explicit state and server-data owners | [Store composition](https://github.com/seandinwiddie/portfolio/blob/main/src/store.ts#L12-L33) and [RTK Query root](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/substrate/kernel/api/apiApi.ts#L17-L70) in `portfolio` |
| Intermediate | Security policy and runtime state isolated by ECS role | [Security policy component](https://github.com/seandinwiddie/api.sdin.dev/blob/e4a03c7e9556116afd82e64f0e07719099d08c0d/src/components/securityPolicy.js#L30-L55) and [rate-limit entity](https://github.com/seandinwiddie/api.sdin.dev/blob/e4a03c7e9556116afd82e64f0e07719099d08c0d/src/entities/rateLimitStore.js#L2-L22) in `api.sdin.dev` |
| Advanced | Server documents normalized and owned at one RTK Query boundary | [RTK Query API system in `portfolio`](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/substrate/kernel/api/apiApi.ts#L17-L70) |
| Advanced | Pure metric derivation separated from the RTK Query composition shell | [Pure metric projections](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/registry/observatory/signalArray/metrics/metricsAdapters.ts#L66-L121) and [query composition](https://github.com/seandinwiddie/portfolio/blob/main/src/features/systems/registry/observatory/signalArray/signalArrayThunks.ts#L23-L80) in `portfolio` |
