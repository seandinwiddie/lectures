...
| Advanced | Source-data authority checked in CI | [API data-authority check in `portfolio`](https://github.com/seandinwiddie/portfolio/blob/main/scripts/check-api-data-authority.mjs#L35-L52) |
| Advanced | FP and Redux contracts checked mechanically | [FP checks](https://github.com/seandinwiddie/portfolio/blob/main/scripts/fp/runFpChecks.mjs#L13-L57) and [Redux checks](https://github.com/seandinwiddie/portfolio/blob/main/scripts/redux/checkConformance.mjs#L70-L99) in `portfolio` |
